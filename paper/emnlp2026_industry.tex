...
Our benchmark fills this gap. Like URGENT, it isolates SE as the variable of
interest but measures its effect on an LLM's task output rather than on transcription or signal quality alone.
...
Open-ended generation tasks (summarisation, question answering, or dialogue)
